...
class MyListTest {
    ...
    @Test
    void compareArray() {
        double average1 = mylist.averageArray(array1);
        double average2 = mylist.averageArray(array2);
    ...
    void averageArray() {
        ...
        assertThat(mylist.averageArray(array3)).isEqualTo(2.2);
    ...
    @Test
    void createArray() {
        //проверка на ограничение длины списка равное 5
        assertThat(mylist.createArray().length).isEqualTo(5);
        //проверка с помощью Mock
